    ...
    ColorGroups = {
        ...
        color_picker: {
            ...
            handleReload: function(e, o) {
                ...
                })) : ($("#color_picker_submit").val("Ulo≈æit"), $("#editcolorform").submit(function(e) {
            ...
            editor: {
                ...
                renameGroup: function(e) {
                    ...
                    o.ajax_request("rename", {
                        ...
                        $("#groupname_" + o.group_id).html(escapeHtml(e)), TWMap.legend.updateHighlight(TWMap.legend.CATEGORY_OTHER, o.group_id, e, a.color), UI.SuccessMessage("Skupina byla √∫spƒõ≈°nƒõ p≈ôejmenov√°na")
                    })
                },
                addTribe: function(e) {
                    this.ajax_request("add_tribe", {
                        ...
                        $("#new_tribe").val("").focus(), MapHighlighter.alterAlly(e.ally_id, e.color), MapHighlighter.colorAlly(e.ally_id), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Do skupiny byl p≈ôid√°n nov√Ω kmen")
                    })
                },
                removeTribe: function(e) {
                    this.ajax_request("del_tribe", {
                        ...
                        MapHighlighter.alterAlly(e, o.color), MapHighlighter.colorAlly(e), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Kmen byl ze skupiny vymaz√°n")
                    })
                },
                addPlayer: function(e) {
                    this.ajax_request("add_player", {
                        ...
                        $("#new_player").val("").focus(), MapHighlighter.alterPlayer(e.player_id, e.color), MapHighlighter.colorPlayer(e.player_id), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Do skupiny byl p≈ôid√°n nov√Ω hr√°ƒç")
                    })
                },
                removePlayer: function(e) {
                    this.ajax_request("del_player", {
                        ...
                        MapHighlighter.alterPlayer(e, o.color), MapHighlighter.colorPlayer(e), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Hr√°ƒç byl ze skupiny vymaz√°n")
                    })
                },
                addVillage: function(e, o) {
                    this.ajax_request("add_village", {
                        ...
                        $("#add_vilage_x").focus(), MapHighlighter.alterVillage(e.village_id, e.color), "undefined" != typeof TWMap.villageKey[e.village_id] && MapHighlighter.colorVillage(TWMap.villages[TWMap.villageKey[e.village_id]]), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Vesnice byla p≈ôid√°na do skupiny")
                    })
                },
                removeVillage: function(e) {
                    this.ajax_request("del_village", {
                        ...
                        MapHighlighter.alterVillage(e, o.color), "undefined" != typeof TWMap.villageKey[e] && MapHighlighter.colorVillage(TWMap.villages[TWMap.villageKey[e]]), TWMap.minimap_cache_stamp++, TWMap.minimap.reload(!0), UI.SuccessMessage("Vesnice byla ze skupiny vymaz√°na")
                    })
                },
...
var TroopTemplates = {
    ...
    validate: function() {
        return $("#template_name").val().length < 1 ? (UI.ErrorMessage("Zadal si neplatnA© jmA©no A!ablony!"), !1) : $("#template_name").val().length > 50 ? (UI.ErrorMessage("NA!zev A!ablony je pAôA≠liA! dlouhA1. (Max. 50 znakAó)"), !1) : "" != $("#template_name").val().trim() || (UI.ErrorMessage("NA!zev A!ablony musA≠ obsahovat alespoA^ jeden viditelnA1 znak."), !1)
    },
    ...
    selectCreate: function(e) {
        if ("undefined" != typeof e && e.preventDefault(), TroopTemplates.currentTemplates >= TroopTemplates.maxTemplates) return UI.ErrorMessage("MaximA!lnA≠ poƒ?et A!ablon pro jednotky dosaA3en!"), !1;
        var t = mobile ? "number" : "text";
        $("#troop_template_units").find("input[type=" + t + "]").val(""), $("#template_id").val(0), $("#template_name").val(""), $("#template_button").val("VytvoAôit A!ablonu"), TroopTemplates.setSelected(0)
    },
    selectTemplate: function() {
        ...
        TroopTemplates.setSelected(a), $("#template_id").val(l.id), $("#template_name").val(l.name), $("#template_button").val("PAôepracovat A!ablonu"), $.each(l, function(e, t) {
            var a = $("#unit_input_" + e);
            a.length && a.val(t)
        })
    },
    ...
    TargetSelection = function(e) {
        ...
        this.$container = null, this.on_confirm_village = function(e) {}, this.request_id = 0, this.selected_index = null, this.num_villages = 0, this.page_limit = null, this.last_attacked = null, this.autocomplete_visible = !1, this.ie_compatibility_mode = !0, this.confirmed_village_data = !1, this.read_only = !1, this.clicked_button = "attack", this.autocomplete_wrapper = null, this.input_text_field = null, this.script_watcher = null, this.script_old_x = "", this.script_old_y = "", this.construct = function(e) {
            ...
            var a = s("%1 (%2|%3)", l, e.x, e.y),
                n = e.player_name ? e.player_name : "BarbaAôi",
...
var Warplanner = {
    ...
    init: function() {
        ...
        this.el.search.change(e).keyup(e).keypress(jQuery.proxy(function(e) {
            ...
            if (Warplanner.locked === !0) return "Zmƒõny v plA!novaƒ?i Aotoku zatA≠m nebyly uloA3eny."
    ...
    hide: function() {
        ...
        var a = "NeuloA3enA© zmƒõny budou ztraceny. Pokraƒ?ovat?",
            t = [{
                text: "Potvrdit",
                callback: e,
                confirm: !0
    ...
    reload: function(e) {
        this.players = {}, $.ajax({
            ...
            success: jQuery.proxy(function(a) {
                if (a.code !== !0) return void UI.ErrorMessage("PAôi naƒ?A≠tA!nA≠ plA!novaƒ?e Aotoku doA!lo k chybƒõ.");
    ...
    save: function() {
        if (this.locked !== !0) return void UI.ErrorMessage("Zmƒõny momentA!lnƒõ nelze uloA3it.");
        var e = {};
    ...
    Modes: {
        ...
        all_own_offer: {
            ...
            acceptOffer: function(e, t) {
                TribalWars.post("market", {
                    ...
                    t.hasOwnProperty("expired") ? (UI.ErrorMessage(t.expired), a.removeOfferDisplay()) : (UI.SuccessMessage("NabA≠dka pAôijata."), 0 === t.offers_remaining ? a.removeOfferDisplay(e) : a.updateOffer(e, t.offers_remaining), a.updateMerchants(t.merchants_available, t.merchants_total, t.merchant_carry))
                })
            },
        ...
        other_offer: {
            ...
            acceptOffer: function(e, t) {
                TribalWars.post("market", {
                    ...
                    e.hasOwnProperty("expired") ? UI.ErrorMessage(e.expired) : UI.SuccessMessage("NabA≠dka pAôijata."), partialReload()
                })
            },
            submitOfferAcceptForm: function(e) {
        ...
        mass_create_offers: {
            ...
            displayCreationErrors: function(e) {
                var t = '<div class="error_box">NƒõkterA© z nabA≠dek nemohly bA1t vytvoAôeny:<ul>';
                $.each(e, function(e, a) {
