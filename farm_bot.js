...
if(window.location.href.indexOf("screen=am_farm")!=-1) {
	...
	mybox.innerHTML+="<h4>FarmBot by -2142-</h4><table style='width:100%'><tr><td>Interval (minut)</td><td><input id='i1' type='number' value='0'></td><tr><td>Max vesnic</td><td><input id='i2' type='number' value='0'></td></tr><tr><td colspan=2 align='center'><input type='button' onclick='run()' value='Start' class='btn'></tr></td></table>";
	...
	function run() {
		...
		{
			mybox.innerHTML="<h4>FarmBot by -2142-</h4><table style='width:100%'><tr><td>Odeslaných útokù:</td><td id='totalattacks'>0</td></tr><tr><td>Další vlna:</td><td id='next_wave'></td></tr></table>";
...
} else { alert("Skript poustej jen v okne Pomocnik rabovani"); }
