...
function loadUI() {
	...
	<tr>
	<td><table>
	<tr><td>Původ:</td><td><input type='text' id='source' style="width:42px;"> <span id="a_source">(klikni na mapě)</span></td></tr>
	<tr><td>Cíl:</td><td><input type='text' id='target' style="width:42px;"> <span id="a_target">(klikni na mapě)</span></td></tr>
	...
	<option>Hlavní budova</option><option>Kasárna</option><option>Stáj</option><option>Dílna</option><option>Strážná věž</option><option>Panský dvůr</option><option>Kovárna</option><option>Nádvoří</option><option>Socha</option><option>Tržiště</option><option>Dřevorubec</option><option>Lom na těbu hlíny</option><option>železný důl</option><option>Selský dvůr</option><option>Skladiště</option><option>Hradby</option>
	</select></td></tr>
