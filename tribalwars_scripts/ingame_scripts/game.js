...
! function() {
    ...
    UI = {
        ...
        Throbber: $('<img alt="NaÄ?A­tA!nA­â€¦" title="NaÄ?A­tA!nA­â€¦" />').attr("src", "/graphic/throbber.gif"),
...
! function() {
    ...
    Premium = {
        ...
        showTransactionCompleteMessage: function() {
            var e = '<div style="max-width: 450px" class="popup_box_header"><h2>Transakce dokonÄ?ena</h2>';
            e += '<img src="' + window.image_base + 'premium/coinbag_large.png" class="float_right" style="margin: 0 5px" />', e += "<p>DA­ky za tvoji platbu! TvA© PrA©miovA© body budou pA™ipsA!ny na tvA—j AoÄ?et v nejbliA3A!A­ dobÄ›.</p>", e += "<p>Pokud neobdrA3A­A! prA©miovA© body bÄ›hem 15 minut, prosA­m nevA!hej a kontaktuj nA!A! Support tA1m.</p>", e += "</div>", Dialog.show("payment_success", e)
        },
    ...
    Quest = function(e) {
        ...
        this.init = function(e) {
            ...
            TribalWars.post("api", {
                ...
                if (e.reward ? UI.SuccessMessage("Aškol dokonÄ?en! ZA­skal jsi:<br /><br />" + e.reward, 3e3) : UI.SuccessMessage("Aškol dokonÄ?en!", 3e3), o.destroy(), mobile) $("#quest-container").hide();
                else {
                    var t = e.detailed;
                    $.each(t, function(e, s) {
                        s.hasOwnProperty("resources") && $.each(s.resources, function(e, s) {
                            TribalWars.showResourceIncrease(e, s)
                        }), s.hasOwnProperty("text") && UI.SuccessMessage("ZA­skanA! odmÄ›na: " + s.text)
                    })
                }
    ...
    ajaxDone: function(e, a) {
        switch (this.hide(), e) {
            ...
            case "unfav":
                ...
                "fav" == e ? UI.SuccessMessage("Vesnice byla pA™idA!na do favoritA—.") : UI.SuccessMessage("Vesnice byla odstranÄ›na z favoritA—.")
        }
    }
};
...
! function() {
    ...
    TribalWars = {
        ...
        updateHeader: function() {
            ...
            c.hasClass("no_new_post") && d ? c.removeClass("no_new_post").addClass("new_post").attr("title", "NovA1 pA™A­spÄ›vek v KmenovA©m fA3rum") : c.hasClass("new_post") && !d && c.removeClass("new_post").addClass("no_new_post").attr("title", "A1A!dnA1 novA1 pA™A­spÄ›vek v KmenovA©m fA3rum"), $(".badge-ally-forum-post").text(d ? " (" + d + ")" : ""), $(".badge-ally-application").text(_ ? " (" + _ + ")" : ""), $(".badge-ally-invite").text(p ? " (" + p + ")" : ""), $("#menu_counter_ally").text(u ? " (" + u + ")" : "");
...
! function() {
    ...
    Resources = function(e, t, o) {
        ...
        toHTML: function(e, t) {
            if (e || (e = "Suroviny jsou k dispozici."), this.available === ResourcesForecast.AVAILABLE_NEVER) return "SkladiA!tÄ› je pA™A­liA! malA©";
...
! function() {
    "use strict";
    Format = {
        month_names: ["Led", "Ašno", "BA™e", "Dub", "KvÄ›", "ÄOvn", "ÄOvc", "Srp", "ZA!A™", "A~A­j", "Lis", "Pro"],
        date: function(e, t) {
        ...
        overdueAnchor: function() {
            return '<a href="minus.php">tA©mÄ›A™ hotovo</a>'
        },
...
! function() {
    ...
    HotKeys = {
        ...
        nextReport: function(e) {
            var o = $("#report-next");
            o.length && (UI.InfoMessage("NaÄ?A­tA!m oznA!menA­..."), document.location.replace(o.attr("href")))
        },
        ...
        nextMail: function(e) {
            var o = $("#igm-next");
            o.length && (UI.InfoMessage("NaÄ?A­tA!nA­ zprA!vy..."), document.location.replace(o.attr("href")))
        },
    ...
    BrowserNotification = {
        ...
        notifications: {
            bn_intro: {
                title: "DivokA© Kmeny",
                properties: {
                    body: "Zapnuli jsme upozornÄ›nA­! Zde vidA­A!, jak takovA© upozornÄ›nA­ bude vypadat!"
                }
            },
            bn_attack: {
            ...
            bn_warehouse: {
                title: "DivokA© Kmeny: SkladiA!tÄ› je plnA©",
                properties: {
                    body: "TvA© skladiA!tÄ› v %1 je plnA©."
                }
            },
            bn_mail: {
            ...
            bn_building: {
                title: "DivokA© Kmeny - VA1stavba dokonÄ?ena",
                properties: {
                    body: "TvA—j stavebnA­ pA™A­kaz %1 ve vesnici %2 byl dokonÄ?en."
                }
            }
        },
        supported: function() {
...
! function() {
    ...
    Connection = {
        ...
        UI.Notification.show("/user_image.php?award=" + n + "&level=" + e.level, "AšspÄ›ch odemÄ?en!", e.name + "<br />" + e.description, i)
        ...
        UI.Notification.show("/user_image.php?award=" + e + "&level=" + data.level, "Stav AospÄ›chu:" + data.name, window.s(i, Format.number(data.current), Format.number(data.max), data.current / data.max * 100), n), UI.InitProgressBars()
        ...
        if (BrowserNotification.showNotification(BrowserNotification.NOTIFICATION_BUILDING, [e.building_order, e.village_name]), TribalWars._settings.inline_notification_building && "main" !== game_data.screen) {
            var n = function() {
                ...
                i = "VA1stavba dokonÄ?ena",
                o = s("TvA—j stavebnA­ pA™A­kaz %1 ve vesnici %2 byl dokonÄ?en.", e.building_order, e.village_name);
        ...
        UI.SuccessMessage(window.s("TvA—j nA!kup %1 PrA©miovA1ch bodA— byl pA™ipsA!n na tvA—j AoÄ?et.", e.pp))
        ...
        if ("event_royalty" !== window.game_data.screen) {
            ...
            switch (e.action) {
                case "cave_lose":
                    ...
                    break;
                case "cave_win":
                    UI.Notification.show(window.image_base + e.additional_data.img, "ÄOlen krA!lovskA© rodiny zachrA!nÄ›n!", "TvA—j stateÄ?nA1 bojovnA­k zachrA!nil Ä?lena krA!lovskA© rodiny!", n);
                    break;
                case "cave_win_full":
                    UI.Notification.show(window.image_base + e.additional_data.img, "ZachrA!nÄ›nA1 Ä?len krA!lovskA© rodiny zemA™el", "TvA—j bojovnA­k zachrA!nil Ä?lena krA!lovskA© rodiny, ale bohuA3el jsi nemÄ›l dostatek volnA©ho prostoru ve svA©m panstvA­.", n);
                    break;
                case "cave_explore":
                    UI.Notification.show(window.image_base + e.additional_data.img, "JeskynÄ› prozkoumA!na", s("V %1 byla nalezena pA™A­A!era.", e.additional_data.name), n)
            }
        }
        ...
        tease: function() {
            var e = '<span class="paris-badge">Odeslat nA!zor</span>',
                s = {
                    ...
                    body: window.s("Kdykoliv nA!m mA—A3eA! rychle sdÄ›lit svA—j nA!zor kliknutA­m na %1 odkaz ve spodnA­ liA!tÄ›.", e),
                    buttonYes: "NynA­ ohodnotit",
                    buttonNo: "MoA3nA! pozdÄ›ji"
                },
    ...
    QuickBar = {
        ...
        showInsecureDialog: function(r) {
            if (QuickBar.loadingQuickBarScript) {
                ...
                i += "<p>Skript ve tvA©m rychlA©m nA!hledu se pokusil naÄ?A­st jinA1 skript, kterA1 nenA­ bezpeÄ?nA1.</p>", i += "<p>Jako souÄ?A!st zabezpeÄ?enA­ tvA©ho internetovA©ho prohlA­A3eÄ?e mohou bA1t skripty naÄ?A­tA!ny pomocA­ bezpeÄ?nA1ch adres, kterA© zaÄ?A­najA­ na <strong>https://</strong></p>", i += "<p>" + s("Adresa URL, kterA! se nedala naÄ?A­st: %1", r) + "</p>", Dialog.close(), Dialog.show("insecure_script", i)
            }
        },
        initProxy: function() {
...
var UnitPopup = {
    ...
    fetchContent: function(t) {
        ...
        var i = Math.round(1 / (60 * e.speed), 2),
            p = 1 === i ? "1 minuta pro pole" : s("%1 Minut pro polA­Ä?ko ", i);
...
! function() {
    ...
    Place = {}, Place.insertAllUnits = function() {
        ...
        generateNewAttackElement: function(t) {
            var n = "";
            if (window.mobile) {
                n += '<table class="vis small units-row">', n += '<tr class="red"><th colspan="6" class="train-name">' + s("Aštok #%1", t) + "</th></td></tr>", n += "<tr>";
                var e = 0;
                ...
                n += "</tr>", n += "</table>"
            } else n += '<tr class="units-row"><th class="train-name"><span>' + s("Aštok #%1", t) + "</span></th>", $.each(this.data.units, function(e, i) {
        ...
        addAdditionalAttack: function() {
            ...
            window.mobile && t.find(".train-name").eq(0).text(s("Aštok #%1", 1));
        ...
        deleteSnobAttack: function(t) {
            ...
            n.each(function(t, n) {
                ...
                }), $(n).find(".train-name span").text(s("Aštok #%1", t + 1))
    ...
    DailyBonus = {
        ...
        updateButtons: function() {
            var t = $("#daily_bonus_content"),
                ...
                i = 'Jakmile budeA! mA­t mA©nÄ› jak 24 hodin do restartu, mA—A3eA! vyuA3A­t prA©miovA© body na odemknutA­ zmeA!kanA1ch truhlA­.<br/><br/>Cena za tuto truhlu: <span class="icon header premium"></span>' + e;
        ...
        updateRewardInfo: function() {
            $.each(this.cycle.rewards, function(t, e) {
                ...
                if (e.is_collected ? i += '<div class="center" style="font-weight:bold;">OdmÄ›na je jiA3 zA­skA!na</div>' : DailyBonus.willChestUnlockTomorrow(t) && (i += '<div class="center" style="font-weight:bold;">K odemÄ?enA­ tA©to truhly se vraAY opÄ›t zA­tra!</div>'), mobile) {
...
! function() {
    ...
    Chat = function() {
        ...
        this.HISTORY_CACHE_TIME = 300, this.init = function() {
            ...
            if ("err_unknown" === e.message ? UI.ErrorMessage(ChatLang.error.unknown) : "err_spam" === e.message ? UI.ErrorMessage("ZdA! se, A3e ti tvA! koÄ?ka pA™ebÄ›hla pA™es klA!vesnici, takA3e jsme nemohli poslat tvoji zprA!vu.") : UI.ErrorMessage(e.message), "message" === e.type) {
...
! function() {
    ...
    ChatLang = {
        general: {
            title: "Chat",
            close: "Opravdu chceA! vypnout chat? Pokud budeA! mA­t chat vypnutA1, ostatnA­m se v nÄ›m zobrazA­A! offline. Jakmile ho vypneA!, zapnout si jej budeA! moct pA™es stranu s hernA­mi nastavenA­mi.",
        ...
        contacts: {
            ...
            ally: "Kmen",
            buddy: "PA™A!telA©",
            none: "NemA!A! A3A!dnA© konverzace, kterA© by se mohly zobrazit. Vstup do nÄ›kterA©ho kmenu a nebo pozdrav hrA!Ä?e ve svA©m okolA­!",
            enter_name: "Zadej jmA©no hrA!Ä?e",
            does_not_exist: "HrA!Ä? s tA­mto jmA©nem neexistuje."
        },
        error: {
            windows: "Pro tuto akci mA!A! otevA™eno pA­A™liA! mnoho oken.",
            unknown: "DoA!lo k neznA!mA© chybÄ›, zkus to prosA­m pozdÄ›ji.",
            insanity: "Je nebezpeÄ?nA© mluvit sA!m se sebou.",
            unavailable: "Nelze se pA™ipojit k chatu, zkus to prosA­m pozdÄ›ji."
        },
        online: {
    ...
    ChatConversation = function(e, t, a) {
        ...
        this.init = function() {
            ...
            var o = s.scrollTop(),
                ...
                c = t.body;
            e.isPlayerBlocked(t.player_id) && (r.addClass("blocked"), c = "HrA!Ä? blokovA!n");
